...
@Slf4j // For creating logs
// NotificationService is responsible for handling notifications in the
// application
public class NotificationService {
    ...
    @Scheduled(cron = "0 0 22 * * *", zone = "IST") // Runs every day at 10 PM IST
    // Method to send notification about the expense
    ...
    @Scheduled(cron = "0 0 23 * * *", zone = "IST") // Runs every day at 11 PM IST
